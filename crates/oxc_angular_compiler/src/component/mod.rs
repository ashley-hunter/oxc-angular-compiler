...
pub use transform::{
    ...
    LinkerHostBindingOutput, LinkerTemplateOutput, NgModuleScopeDep, ResolvedResources,
    TemplateCompileOutput, TransformOptions, TransformResult, build_import_map,
